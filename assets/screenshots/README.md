...
## Still to add
A few shots from earlier plans aren't captured yet — for example the Windows edition screen during
setup, the Sysmon events in the dashboard, and a general overview. I'll add those when I redo or
revisit those parts.
