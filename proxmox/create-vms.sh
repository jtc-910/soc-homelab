...
qm create 110 --name DC01 --memory 6144 --cores 4 --cpu host \
    --net0 virtio,bridge=vmbr1 --ostype win11 --machine q35 --bios ovmf

qm set 110 --scsihw virtio-scsi-pci
qm set 110 --scsi0 "${STORAGE}:80"
...
qm set 110 --boot order=scsi0\;ide0
...
qm set 120 --boot order=scsi0\;ide0
